 ...
 */
public class CustomJitsiMeetActivity extends AppCompatActivity
    implements JitsiMeetActivityInterface {

    protected static final String TAG = CustomJitsiMeetActivity.class.getSimpleName();
     ...
     * initialization is delayed and the {@link CustomJitsiMeetActivity#initialize()} method is not
